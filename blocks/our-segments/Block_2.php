...
<section class="bg-orange-section">
        ...
        <div class="container py-sm-5 py-3">
            <div class="row mb-5">
                <div class="col-12">
                    <img class="d-md-block d-none w-100" src="<?php echo $block_two_fields['desktop_image']; ?>" alt="desktop_image">
                    <img class="d-md-none d-block w-100" src="<?php echo $block_two_fields['mobile_image']; ?>" alt="mobile_image">
                </div>
            </div>
